...
\begin{lstlisting}[language=C++, caption=Branchless Error Correction Engine]
uint32_t syndrome = (s4 << 2) | (s2 << 1) | s1;
// Branchless Error Masking (0 CPU branch mispredictions)
uint32_t mask = (syndrome != 0) ? (1U << (syndrome - 1)) : 0U;
codeword ^= mask; // Hardware bit correction in 1 CPU cycle
\end{lstlisting}
